...
namespace DS4Windows
{
    ...
    public class Global
    {
        ...
        public static bool CheckForDevice(string guid)
        {
            ...
            IntPtr deviceInfoSet = SetupApi.SetupDiGetClassDevs(ref deviceGuid, null, 0,
                SetupApi.DIGCF_DEVICEINTERFACE);
            result = SetupApi.SetupDiEnumDeviceInfo(deviceInfoSet, 0, ref deviceInfoData);
        ...
        private static void FindViGEmDeviceInfo()
        {
            ...
            SetupApi.DEVPROPKEY[] lookupProperties = new SetupApi.DEVPROPKEY[]
            {
                SetupApi.DEVPKEY_Device_DriverVersion, SetupApi.DEVPKEY_Device_InstanceId,
                SetupApi.DEVPKEY_Device_Manufacturer, SetupApi.DEVPKEY_Device_Provider,
                SetupApi.DEVPKEY_Device_DeviceDesc,
            };
            ...
            IntPtr deviceInfoSet = SetupApi.SetupDiGetClassDevs(ref deviceGuid, null, 0,
                SetupApi.DIGCF_DEVICEINTERFACE);
            for (int i = 0; !result && SetupApi.SetupDiEnumDeviceInfo(deviceInfoSet, i, ref deviceInfoData); i++)
            {
                ViGEmBusInfo tempBusInfo = new ViGEmBusInfo();

                foreach (SetupApi.DEVPROPKEY currentDevKey in lookupProperties)
                {
                    SetupApi.DEVPROPKEY tempKey = currentDevKey;
                    if (SetupApi.SetupDiGetDeviceProperty(deviceInfoSet, ref deviceInfoData,
                        ref tempKey, ref propertyType,
                        dataBuffer, dataBuffer.Length, ref requiredSize, 0))
                    {
                        string temp = dataBuffer.ToUTF16String();
                        if (currentDevKey.fmtid == SetupApi.DEVPKEY_Device_DriverVersion.fmtid &&
                            currentDevKey.pid == SetupApi.DEVPKEY_Device_DriverVersion.pid)
                        {
                            try
                            {
                        ...
                        else if (currentDevKey.fmtid == SetupApi.DEVPKEY_Device_InstanceId.fmtid &&
                            currentDevKey.pid == SetupApi.DEVPKEY_Device_InstanceId.pid)
                        {
                            tempBusInfo.instanceId = temp;
                        }
                        else if (currentDevKey.fmtid == SetupApi.DEVPKEY_Device_Manufacturer.fmtid &&
                            currentDevKey.pid == SetupApi.DEVPKEY_Device_Manufacturer.pid)
                        {
                            tempBusInfo.manufacturer = temp;
                        }
                        else if (currentDevKey.fmtid == SetupApi.DEVPKEY_Device_Provider.fmtid &&
                            currentDevKey.pid == SetupApi.DEVPKEY_Device_Provider.pid)
                        {
                            tempBusInfo.driverProviderName = temp;
                        }
                        else if (currentDevKey.fmtid == SetupApi.DEVPKEY_Device_DeviceDesc.fmtid &&
                            currentDevKey.pid == SetupApi.DEVPKEY_Device_DeviceDesc.pid)
                        {
        ...
        private static bool CheckForSysDevice(string searchHardwareId)
        {
            ...
            ulong propertyType = 0;
            var requiredSize = 0;
            IntPtr deviceInfoSet = SetupApi.SetupDiGetClassDevs(ref sysGuid, null, 0, 0);
            for (int i = 0; !result && SetupApi.SetupDiEnumDeviceInfo(deviceInfoSet, i, ref deviceInfoData); i++)
            {
                if (SetupApi.SetupDiGetDeviceProperty(deviceInfoSet, ref deviceInfoData,
                    ref SetupApi.DEVPKEY_Device_HardwareIds, ref propertyType,
                    dataBuffer, dataBuffer.Length, ref requiredSize, 0))
                {
            ...
            SetupApi.DEVPROPKEY prop)
        {
            ...
            IntPtr deviceInfoSet = SetupApi.SetupDiGetClassDevs(ref hidGuid, deviceInstanceId, 0, SetupApi.DIGCF_PRESENT | SetupApi.DIGCF_DEVICEINTERFACE);
            SetupApi.SetupDiEnumDeviceInfo(deviceInfoSet, 0, ref deviceInfoData);
            if (SetupApi.SetupDiGetDeviceProperty(deviceInfoSet, ref deviceInfoData, ref prop, ref propertyType,
                    dataBuffer, dataBuffer.Length, ref requiredSize, 0))
            {
        ...
        private static string FakerInputVersion()
        {
            ...
            IntPtr deviceInfoSet = SetupApi.SetupDiGetClassDevs(ref Util.fakerInputGuid, null, 0, SetupApi.DIGCF_DEVICEINTERFACE);
            SetupApi.SP_DEVINFO_DATA deviceInfoData = new SetupApi.SP_DEVINFO_DATA();
            deviceInfoData.cbSize = System.Runtime.InteropServices.Marshal.SizeOf(deviceInfoData);
            bool foundDev = false;
            //bool success = SetupApi.SetupDiEnumDeviceInfo(deviceInfoSet, 0, ref deviceInfoData);
            for (int i = 0; !foundDev && SetupApi.SetupDiEnumDeviceInfo(deviceInfoSet, i, ref deviceInfoData); i++)
            {
                ulong devPropertyType = 0;
                int requiredSizeProp = 0;
                SetupApi.SetupDiGetDeviceProperty(deviceInfoSet, ref deviceInfoData,
                    ref SetupApi.DEVPKEY_Device_DriverVersion, ref devPropertyType, null, 0, ref requiredSizeProp, 0);

                if (requiredSizeProp > 0)
                {
                    var versionTextBuffer = new byte[requiredSizeProp];
                    SetupApi.SetupDiGetDeviceProperty(deviceInfoSet, ref deviceInfoData,
                        ref SetupApi.DEVPKEY_Device_DriverVersion, ref devPropertyType, versionTextBuffer, requiredSizeProp, ref requiredSizeProp, 0);
        ...
        public static void SetGyroMouseStickToggle(int index, bool value, IControlService control)
        ...
        public static void SetGyroMouseDeadZone(int index, int value, IControlService control)
        {
            m_Config.SetGyroMouseDZ(index, value, control);
        }

        public static bool[] GyroMouseToggle => m_Config.gyroMouseToggle;
        public static void SetGyroMouseToggle(int index, bool value, IControlService control) 
            => m_Config.SetGyroMouseToggle(index, value, control);

        public static void SetGyroControlsToggle(int index, bool value, IControlService control)
        ...
        public static bool LoadProfile(int device, bool launchprogram, IControlService control,
        ...
        public static bool LoadTempProfile(int device, string name, bool launchprogram,
            IControlService control, bool xinputChange = true)
        {
        ...
        public static void LoadBlankDevProfile(int device, bool launchprogram, IControlService control,
            bool xinputChange = true, bool postLoad = true)
        {
        ...
        public static void LoadBlankDS4Profile(int device, bool launchprogram, IControlService control,
            bool xinputChange = true, bool postLoad = true)
        {
        ...
        public static void LoadDefaultGamepadGyroProfile(int device, bool launchprogram, IControlService control,
            bool xinputChange = true, bool postLoad = true)
        {
        ...
        public static void LoadDefaultDS4GamepadGyroProfile(int device, bool launchprogram, IControlService control,
            bool xinputChange = true, bool postLoad = true)
        {
        ...
        public static void LoadDefaultMixedControlsProfile(int device, bool launchprogram, IControlService control,
            bool xinputChange = true, bool postLoad = true)
        {
        ...
        public static void LoadDefaultDS4MixedControlsProfile(int device, bool launchprogram, IControlService control,
            bool xinputChange = true, bool postLoad = true)
        {
            m_Config.LoadDefaultMixedControlsProfile(device, launchprogram, control, "", xinputChange, postLoad);
            m_Config.EstablishDefaultSpecialActions(device);
        ...
        public static void LoadDefaultMixedGyroMouseProfile(int device, bool launchprogram, IControlService control,
            bool xinputChange = true, bool postLoad = true)
        {
        ...
        public static void LoadDefaultDS4MixedGyroMouseProfile(int device, bool launchprogram, IControlService control,
            bool xinputChange = true, bool postLoad = true)
        {
        ...
        public static void LoadDefaultKBMProfile(int device, bool launchprogram, IControlService control,
            bool xinputChange = true, bool postLoad = true)
        {
        ...
        public static void LoadDefaultKBMGyroMouseProfile(int device, bool launchprogram, IControlService control,
            bool xinputChange = true, bool postLoad = true)
        {
        ...
        public static bool SaveControllerConfigs(DS4Device device = null)
        {
            ...
            for (int idx = 0; idx < IControlService.MAX_DS4_CONTROLLER_COUNT; idx++)
    ...
    public class BackingStore
    {
        ...
        public void SetGyroMouseDZ(int index, int value, IControlService control)
        {
            gyroMouseDZ[index] = value;
            if (index < IControlService.CURRENT_DS4_CONTROLLER_LIMIT && control.TouchPad[index] != null)
                control.TouchPad[index].CursorGyroDead = value;
        }

        public void SetGyroControlsToggle(int index, bool value, IControlService control)
        {
        ...
        public void SetGyroMouseToggle(int index, bool value, IControlService control)
        {
        ...
        public void SetGyroMouseStickToggle(int index, bool value, IControlService control)
        {
        ...
        public bool LoadProfile(int device, bool launchprogram, IControlService control,
            string propath = "", bool xinputChange = true, bool postLoad = true)
        {
            ...
            if (File.Exists(profilepath))
            {
                ...
                */
                ...
                if (xinputChange && device < IControlService.CURRENT_DS4_CONTROLLER_LIMIT)
                {
            ...
            else
            {
                ...
                OutputDevice tempOutDev = device < IControlService.CURRENT_DS4_CONTROLLER_LIMIT ?
        ...
        public bool SaveAction(string name, string controls, int mode, string details, bool edit, string extras = "")
        {
            ...
            catch (XmlException)
            {
                ...
                AppLogger.LogToGui(Localization.XMLActionsCorrupt, true);
                m_Xdoc.RemoveAll();
                PrepareActionsXml(m_Xdoc);
            }
        ...
        private void ResetMouseProperties(int device, IControlService control)
        {
            if (device < Global.MAX_DS4_CONTROLLER_COUNT &&
        ...
        private void PrepareBlankingProfile(int device, IControlService control, out bool xinputPlug, out bool xinputStatus, bool xinputChange = true)
        {
            xinputPlug = false;
            xinputStatus = false;
        ...
        public void LoadBlankDS4Profile(int device, bool launchprogram, IControlService control,
            string propath = "", bool xinputChange = true, bool postLoad = true)
        {
        ...
        public void LoadBlankProfile(int device, bool launchprogram, IControlService control,
            string propath = "", bool xinputChange = true, bool postLoad = true)
        {
            bool xinputPlug = false;
            bool xinputStatus = false;
        ...
        public void LoadDefaultGamepadGyroProfile(int device, bool launchprogram, IControlService control,
            string propath = "", bool xinputChange = true, bool postLoad = true)
        {
            bool xinputPlug = false;
            bool xinputStatus = false;
        ...
        public void LoadDefaultDS4GamepadGyroProfile(int device, bool launchprogram, IControlService control,
            string propath = "", bool xinputChange = true, bool postLoad = true)
        {
            PrepareBlankingProfile(device, control, out bool xinputPlug, out bool xinputStatus, xinputChange);
        ...
        public void LoadDefaultMixedGyroMouseProfile(int device, bool launchprogram, IControlService control,
            string propath = "", bool xinputChange = true, bool postLoad = true)
        {
            bool xinputPlug = false;
            bool xinputStatus = false;
        ...
        public void LoadDefaultDS4MixedGyroMouseProfile(int device, bool launchprogram, IControlService control,
            string propath = "", bool xinputChange = true, bool postLoad = true)
        {
            PrepareBlankingProfile(device, control, out bool xinputPlug, out bool xinputStatus, xinputChange);
        ...
        public void LoadDefaultDS4MixedControlsProfile(int device, bool launchprogram, IControlService control,
            string propath = "", bool xinputChange = true, bool postLoad = true)
        {
            PrepareBlankingProfile(device, control, out bool xinputPlug, out bool xinputStatus, xinputChange);
        ...
        public void LoadDefaultMixedControlsProfile(int device, bool launchprogram, IControlService control,
            string propath = "", bool xinputChange = true, bool postLoad = true)
        {
            bool xinputPlug = false;
            bool xinputStatus = false;
        ...
        public void LoadDefaultKBMProfile(int device, bool launchprogram, IControlService control,
            string propath = "", bool xinputChange = true, bool postLoad = true)
        {
            bool xinputPlug = false;
            bool xinputStatus = false;
        ...
        public void LoadDefaultKBMGyroMouseProfile(int device, bool launchprogram, IControlService control,
            string propath = "", bool xinputChange = true, bool postLoad = true)
        {
            bool xinputPlug = false;
            bool xinputStatus = false;
        ...
        private void CheckOldDevicestatus(int device, IControlService control,
            OutContType oldContType, out bool xinputPlug, out bool xinputStatus)
        {
            xinputPlug = false;
            xinputStatus = false;

            if (device < IControlService.CURRENT_DS4_CONTROLLER_LIMIT)
            {
                bool oldUseDInputOnly = Global.useDInputOnly[device];
        ...
        private void PostLoadSnippet(int device, IControlService control, bool xinputStatus, bool xinputPlug)
        {
            DS4Device tempDev = control.DS4Controllers[device];
            if (tempDev != null && tempDev.isSynced())
            {
