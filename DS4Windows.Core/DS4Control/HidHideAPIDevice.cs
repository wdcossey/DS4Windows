...
namespace DS4WinWPF.DS4Control
{
    class HidHideAPIDevice : IDisposable
    {
        ...
        {
            hidHideHandle = Kernel32.CreateFile(CONTROL_DEVICE_FILENAME,
        ...
        public bool GetActiveState()
        {
            ...
            {
                int bytesReturned = 0;
                Kernel32.DeviceIoControl(hidHideHandle.DangerousGetHandle(),
        ...
        public List<string> GetBlacklist()
        {
            ...
            int bytesReturned = 0;
            bool result = Kernel32.DeviceIoControl(hidHideHandle.DangerousGetHandle(),
            ...
            if (bytesReturned > 0)
            {
                ...
                result = Kernel32.DeviceIoControl(hidHideHandle.DangerousGetHandle(),
                    HidHideAPIDevice.IOCTL_GET_BLACKLIST,
                    IntPtr.Zero,
                    0,
                    buffer,
