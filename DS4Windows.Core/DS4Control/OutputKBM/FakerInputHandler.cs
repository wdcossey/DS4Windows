...
namespace DS4Windows.DS4Control
{
    public class FakerInputHandler : VirtualKBMBase
    {
        ...
        private RelativeMouseReport mouseReport = new();
        private AbsoluteMouseReport absoluteMouseReport = new();
        private KeyboardReport keyReport = new();
        private KeyboardEnhancedReport mediaKeyReport = new();

        private HashSet<KeyboardModifier> modifiers = new();
        private HashSet<KeyboardKey> pressedKeys = new();
        ...
        private ReaderWriterLockSlim eventLock = new();
