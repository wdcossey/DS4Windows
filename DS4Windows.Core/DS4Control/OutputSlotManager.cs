...
namespace DS4Windows
{
    public class OutputSlotManager
    {
        ...
        */
        ...
        private Dictionary<int, OutputDevice> deviceDict = new();
        private Dictionary<OutputDevice, int> revDeviceDict = new();
        private OutputDevice[] outputDevices = new OutputDevice[IControlService.CURRENT_DS4_CONTROLLER_LIMIT];
        ...
        {
            outputSlots = new OutSlotDevice[IControlService.CURRENT_DS4_CONTROLLER_LIMIT];
            for (int i = 0; i < IControlService.CURRENT_DS4_CONTROLLER_LIMIT; i++)
            {
