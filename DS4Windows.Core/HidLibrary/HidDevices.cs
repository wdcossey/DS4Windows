...
namespace DS4Windows
{
    public class HidDevices
    {
        ...
        private static SetupApi.SP_DEVINFO_DATA CreateDeviceInfoData()
        {
        ...
        private static string GetDevicePath(IntPtr deviceInfoSet, SetupApi.SP_DEVICE_INTERFACE_DATA deviceInterfaceData)
        {
            var bufferSize = 0;
            var interfaceDetail = new SetupApi.SP_DEVICE_INTERFACE_DETAIL_DATA { Size = IntPtr.Size == 4 ? 4 + Marshal.SystemDefaultCharSize : 8 };
            ...
            return SetupApi.SetupDiGetDeviceInterfaceDetail(deviceInfoSet, ref deviceInterfaceData, ref interfaceDetail, bufferSize, ref bufferSize, IntPtr.Zero) ? 
        ...
        public static Guid HidClassGuid
        {
            get
            {
                if (_hidClassGuid.Equals(Guid.Empty)) Hid.HidD_GetHidGuid(ref _hidClassGuid);
                return _hidClassGuid;
            }
        }

        private static string GetDeviceDescription(IntPtr deviceInfoSet, ref SetupApi.SP_DEVINFO_DATA devinfoData)
        {
            ...
            SetupApi.SetupDiGetDeviceRegistryProperty(deviceInfoSet,
                                                            ref devinfoData,
        ...
        private static string GetBusReportedDeviceDescription(IntPtr deviceInfoSet, ref SetupApi.SP_DEVINFO_DATA devinfoData)
        {
            var descriptionBuffer = new byte[1024];
            ...
            if (Environment.OSVersion.Version.Major > 5)
            {
                ...
                var _continue = SetupApi.SetupDiGetDeviceProperty(deviceInfoSet,
                                                                        ref devinfoData,
                                                                        ref SetupApi.DEVPKEY_Device_BusReportedDeviceDesc,
                                                                        ref propertyType,
                                                                        descriptionBuffer,
                                                                        descriptionBuffer.Length,
                                                                        ref requiredSize,
        ...
        private static string GetDeviceParent(IntPtr deviceInfoSet, ref SetupApi.SP_DEVINFO_DATA devinfoData)
        {
            ...
            SetupApi.SetupDiGetDeviceProperty(deviceInfoSet, ref devinfoData,
                                                        ref SetupApi.DEVPKEY_Device_Parent, ref propertyType,
                                                        null, 0,
                                                        ref requiredSize, 0);
