...
#pragma warning restore 618
    ...
    /////	General driver data
    public short GetvJoyVersion() { return vJoyInterface.GetvJoyVersion(); }
    public bool vJoyEnabled() { return vJoyInterface.vJoyEnabled(); }
    public string GetvJoyProductString() { return Marshal.PtrToStringAuto(vJoyInterface.GetvJoyProductString()); }
    public string GetvJoyManufacturerString() { return Marshal.PtrToStringAuto(vJoyInterface.GetvJoyManufacturerString()); }
    public string GetvJoySerialNumberString() { return Marshal.PtrToStringAuto(vJoyInterface.GetvJoySerialNumberString()); }
    public bool DriverMatch(ref UInt32 DllVer, ref UInt32 DrvVer) { return vJoyInterface.DriverMatch(ref DllVer, ref DrvVer); }

    /////	vJoy Device properties
    public int GetVJDButtonNumber(uint rID) { return vJoyInterface.GetVJDButtonNumber(rID); }
    public int GetVJDDiscPovNumber(uint rID) { return vJoyInterface.GetVJDDiscPovNumber(rID); }
    public int GetVJDContPovNumber(uint rID) { return vJoyInterface.GetVJDContPovNumber(rID); }
    public bool GetVJDAxisExist(UInt32 rID, HID_USAGES Axis)
    {
        UInt32 res = vJoyInterface.GetVJDAxisExist(rID, (uint)Axis);
        if (res == 1)
            return true;
        else
            return false;
    }
    public bool GetVJDAxisMax(UInt32 rID, HID_USAGES Axis, ref long Max) { return vJoyInterface.GetVJDAxisMax(rID, (uint)Axis, ref Max); }
    public bool GetVJDAxisMin(UInt32 rID, HID_USAGES Axis, ref long Min) { return vJoyInterface.GetVJDAxisMin(rID, (uint)Axis, ref Min); }
    public bool isVJDExists(UInt32 rID) { return vJoyInterface.isVJDExists(rID); }
    public int GetOwnerPid(UInt32 rID) { return vJoyInterface.GetOwnerPid(rID); }

    /////	Write access to vJoy Device - Basic
    public bool AcquireVJD(UInt32 rID) { return vJoyInterface.AcquireVJD(rID); }
    public void RelinquishVJD(uint rID) { vJoyInterface.RelinquishVJD(rID); }
    public bool UpdateVJD(UInt32 rID, ref JoystickState pData) { return vJoyInterface.UpdateVJD(rID, ref pData); }
    public VjdStat GetVJDStatus(UInt32 rID) { return (VjdStat)vJoyInterface.GetVJDStatus(rID); }

    //// Reset functions
    public bool ResetVJD(UInt32 rID) { return vJoyInterface.ResetVJD(rID); }
    public bool ResetAll() { return vJoyInterface.ResetAll(); }
    public bool ResetButtons(UInt32 rID) { return vJoyInterface.ResetButtons(rID); }
    public bool ResetPovs(UInt32 rID) { return vJoyInterface.ResetPovs(rID); }

    ////// Write data
    public bool SetAxis(Int32 Value, UInt32 rID, HID_USAGES Axis) { return vJoyInterface.SetAxis(Value, rID, Axis); }
    public bool SetBtn(bool Value, UInt32 rID, uint nBtn) { return vJoyInterface.SetBtn(Value, rID, (Byte)nBtn); }
    public bool SetDiscPov(Int32 Value, UInt32 rID, uint nPov) { return vJoyInterface.SetDiscPov(Value, rID, nPov); }
    public bool SetContPov(Int32 Value, UInt32 rID, uint nPov) { return vJoyInterface.SetContPov(Value, rID, nPov); }
    ...
    public void RegisterRemovalCB(RemovalCbFunc cb, object data)
    {
        ...
        vJoyInterface.RegisterRemovalCB(wrf, (IntPtr)hRemUserData);
    }
    ...
    public void RegisterRemovalCB(WrapRemovalCbFunc cb, IntPtr data)
    {
        ...
        vJoyInterface.RegisterRemovalCB(wrf, data);
    }
