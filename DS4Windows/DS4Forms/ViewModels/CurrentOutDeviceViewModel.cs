...
public class CurrentOutDeviceViewModel
{
    ...
    public CurrentOutDeviceViewModel(IControlService controlService,
        OutputSlotManager outputMan)
    {
        outSlotManager = outputMan;
        // Set initial capacity at input controller limit in app
        slotDeviceEntries = new List<SlotDeviceEntry>(IControlService.CURRENT_DS4_CONTROLLER_LIMIT);
        int idx = 0;
