...
public class ProfileSettingsViewModel
{
    ...
    public int GyroMouseDeadZone
    {
        ...
        set
        {
            Global.SetGyroMouseDeadZone(device, value, this.controlService);
    ...
    public bool GyroMouseToggle
    {
        ...
        set
        {
            Global.SetGyroMouseToggle(device, value, this.controlService);
        }
    }
    ...
    public bool GyroMouseStickToggle
    {
        ...
        set
        {
            Global.SetGyroMouseStickToggle(device, value, this.controlService);
        }
    }
    ...
    public bool GyroControlsToggle
    {
        ...
        set
        {
            Global.SetGyroControlsToggle(device, value, this.controlService);
        }
    }
    ...
    public ProfileSettingsViewModel(IControlService controlService, int device)
    {
        this.controlService = controlService;
        this.device = device;
        funcDevNum = device < IControlService.CURRENT_DS4_CONTROLLER_LIMIT ? device : 0;
