...
{
    private readonly IBindingWindowFactory bindingWindowFactory;
    ...
    public SpecialActionEditor(IBindingWindowFactory bindingWindowFactory, int deviceNum, ProfileList profileList,
        DS4Windows.SpecialAction specialAction = null)
    {
        this.bindingWindowFactory = bindingWindowFactory;
        InitializeComponent();
    ...
    private void SaveBtn_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            MessageBox.Show(Localization.ActionExists);
        }
    ...
    private void PressKeySelectBtn_Click(object sender, RoutedEventArgs e)
    {
        ...
        BindingWindow window = this.bindingWindowFactory.Create(specialActVM.DeviceNum, settings,
